...
The BE is designed to be deployed using Docker. It requeres a parent docker-compose file to set up the database, backend and frontend together on the same network.
